                ...
                <div class="basis-[22%]">
                    ...
                    <div class="flex flex-col items-center pt-[1rem]">
                        ...
                        <div class="w-full pt-[1rem] px-[0.5rem] flex gap-[0.8rem] items-center">
                            ...
                            <?php else : ?>
                                <a href="src/view/detailsBook.php?id=<?= $bookData["id"] ?>" class="basis-[100%] bg-[#F4C496] rounded text-center py-[0.3rem] text-[1rem] text-[#686868] font-bold hover:bg-[#f2aa65] hover:text-white transition-all ease-in-out">Read more...</a>
                            <?php endif; ?>
                        </div>
