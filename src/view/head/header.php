    ...
    <div class="relative w-full max-w-4xl max-h-full"> <!-- MAIN MODAL -->
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 flex">
            ...
            <div class="hidden md:block md:w-1/2 p-6">
                <img src="./src/resources/img/imagen-login 1.svg" alt="Left Side Image" class="object-cover w-full h-full rounded-lg">
            </div>
            <div class="w-full md:w-1/2"> <!-- Right Side Content -->
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="C:/xampp/htdocs/booknook/src/controller/LoginController.php" method="post">
                        <div>
